                                ...
                                @csrf
                                  ...
                                  <div class="d-inline-block w-100">
                                      <div class="custom-control custom-checkbox d-inline-block mt-2 pt-1">
                                          ...
                                          <label class="custom-control-label" for="customCheck1">Tôi đồng ý <a href="#" class="text-light">các điều khoản và điều kiện</a></label>
                                      </div>
                                  </div>
                                  <div class="sign-info text-center">
                                      <button class="btn btn-white d-block w-100 mb-2">Đăng ký</button>

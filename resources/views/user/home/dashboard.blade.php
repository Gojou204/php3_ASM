                              ...
                              <div class="iq-card-body p-0">
                                 <div class="d-flex align-items-center">
                                    <div class="col-6 p-0 position-relative image-overlap-shadow">
                                       <a href="javascript:void();"><img class="img-fluid rounded w-100" src="{{ asset($book->image) }}" alt="{{ $book->name }}"></a>
                                       <div class="view-book">
                                    ...
                                    <div class="col-6">
                                       <div class="mb-2">
                                          ...
                                          <p class="font-size-13 line-height mb-1">{{ $book->author ? $book->author->name : 'Unknown' }}</p>
                                          <div class="d-block line-height">
                                             ...
                                             {{-- <span class="font-size-11 text-warning">
                                                @for ($i = 0; $i < 5; $i++)
                                                    <i class="fa fa-star{{ $i < $book->rating ? '' : '-o' }}"></i>
                                                @endfor
                                            </span>                                              --}}
                                          </div>
                                       </div>
                     ...
                     @foreach($topCategories as $category)
                        <li class="col-sm-6 d-flex mb-3 align-items-center">
                           <div class="icon iq-icon-box mr-3">
                              <a href="javascript:void();"><img class="img-fluid avatar-60 rounded-circle" src="./../images/page-img/featured-book.png" alt=""></a>
                           </div>
                           <div class="mt-1">
                              <h6>{{ $category->name }}</h6>
                              <p class="mb-0 text-primary">Số lượng sách: <span class="text-body">{{ $category->books_count }}</span></p>
                           </div>
                        </li>
                     @endforeach
